...
// solid heading (now the display typeface, via index.css's global h1 rule)
// and a single accent-colored rule are enough signal.
export function PageHero({ eyebrow, title, description }: Props) {
  return (
    <div className="rounded-xl border border-border bg-surface p-8 border-l-2 border-l-accent-500">
